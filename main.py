...
from ingest import ingest, create_search_index
...
if __name__ == "__main__":
    ...
    openai_client = OpenAI(
        base_url="https://demo.deployradiant.com/mongodb-rag-example/openai/", api_key="notNeeded"
    )
    ...
    result = query_results(openai_client=openai_client, collection=collection, field=embedding_field_name, index=embedding_field_name+"_index", query=query)
    print(result)
